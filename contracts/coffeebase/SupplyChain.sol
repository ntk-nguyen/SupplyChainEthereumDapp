    ...
    ConsumerRole
{
    ...
    modifier harvested(uint256 _upc) {
        require(
            ...
            "Item needs to be in the State of Harvested"
        );
        _;
    }
    ...
    modifier processed(uint256 _upc) {
        require(
            ...
            "Item needs to be in the State of Processed"
        );
        _;
    }
    ...
    modifier packed(uint256 _upc) {
        require(
            ...
            "Item needs to be in the State of Packed"
        );
        _;
    }
    ...
    modifier sold(uint256 _upc) {
        require(
            ...
            "Item needs to be in the State of Sold"
        );
        _;
    }
    ...
    modifier shipped(uint256 _upc) {
        require(
            ...
            "Item needs to be in the State of Shipped"
        );
        _;
    }
    ...
    modifier received(uint256 _upc) {
        require(
            ...
            "Item needs to be in the State of Received"
        );
        _;
    }
    ...
    modifier purchased(uint256 _upc) {
        require(
            ...
            "Item needs to be in the State of Purchased"
        );
        _;
    }
